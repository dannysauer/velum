...
describe AdmissionWebhookForm do
  describe "validations" do
    ...
    let(:ca_file) do
      Rack::Test::UploadedFile.new(Rails.root.join("spec", "fixtures", "ca.crt"))
    end
    let(:key_file) do
      Rack::Test::UploadedFile.new(Rails.root.join("spec", "fixtures", "admin.key"))
    end
    let(:empty_file) do
      Rack::Test::UploadedFile.new(Rails.root.join("spec", "fixtures", "empty.txt"))
    end
    let(:invalid_key_file) do
      Rack::Test::UploadedFile.new(Rails.root.join("spec", "fixtures", "invalid.key"))
    end
  ...
  describe "#key" do
    it "returns content of uploadad key file" do
      key_file = Rack::Test::UploadedFile.new(Rails.root.join("spec", "fixtures", "admin.key"))
  ...
  describe "#certificate" do
    it "returns content of uploadad cert file" do
      cert_file = Rack::Test::UploadedFile.new(Rails.root.join("spec", "fixtures", "admin.crt"))
